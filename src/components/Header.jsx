    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-5 text-gray-700 text-[22px]">
          <a href="https://www.instagram.com/vaivendas/" target="_blank" rel="noreferrer" className="hover:text-brand transition-all hover:scale-[1.05]">
            <FaInstagram />
          </a>
          <a href={whatsappUrl} target="_blank" rel="noreferrer" className="hover:text-brand transition-all hover:scale-[1.05]">
            <FaWhatsapp />
          </a>
          <a href="https://www.youtube.com/@vaidavenda" target="_blank" rel="noreferrer" className="hover:text-brand transition-all hover:scale-[1.05]">
            <FaYoutube />
          </a>
        </div>
        ...
        <div className="md:hidden bg-white/90 backdrop-blur-lg border-t shadow-sm">
          <nav className="flex flex-col px-6 py-4 space-y-4 font-semibold text-gray-700">
            ...
            <div className="flex items-center space-x-6 pt-2 text-[24px]">
              <a href="https://www.instagram.com/vaivendas/" target="_blank" rel="noreferrer" className="hover:text-brand transition">
                <FaInstagram />  {/* ← corrigido */}
              </a>
              <a href={whatsappUrl} target="_blank" rel="noreferrer" className="hover:text-brand transition">
                <FaWhatsapp />   {/* ← corrigido */}
              </a>
              <a href="https://www.youtube.com/@vaidavenda" target="_blank" rel="noreferrer" className="hover:text-brand transition">
                <FaYoutube />    {/* ← corrigido */}
              </a>
            </div>
          </nav>
